  ...
  return (
    <div className='home-page'>
      ...
      <div className='letter-section'>
        <h2 className='letter-head'>Fall 2024 Recruitment</h2>
        <p className='letter-text'>ʚ𖦹ɞ⋆｡‧˚life's sweeter with phi rho˚‧｡⋆ʚ𖦹ɞ</p>
        <Link to="/fall2024" className='learn-more-button'>learn more</Link>
