  ...
  return (
    <div className="fall2024-container">
      <div className="buttons-container">
        ...
        <Link to="/accepted-majors" className="recruitment-button accepted-majors-button">Accepted Majors</Link>
      </div>

      <div className="content-container">
        <img src={flyerfa24} alt="Fall 2024 Recruitment Flyer" className="flyerfa24" />
        <div className="letter-container">
          ...
          <p className="letter-paragraph">
            ...
            Phi Rho Love, <br/><br/>
            Paulina and Claire <br/>
            Recruitment Chairs
          </p>
          <img src={claire} alt="Claire" className="claire" />
          <img src={paulina} alt="Paulina" className="paulina" />
        </div>
      </div>
    </div>
  );
